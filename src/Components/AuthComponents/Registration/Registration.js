    ...
    const handleRegistration = (e) => {
        ...
        try {
            if (password < 5) {
                ...
                setErrors({ confirmPassword: "Confirm password must be same as password" })
                return
            }
            navigate('/')
        } catch (e) {
        ...
        <div id='regBackdrop'>
            <div id='regModal'>
                <div id='fontContainer'>
                    <div id='font'>
                        <FontAwesomeIcon icon={faXmark} onClick={handleCancelCreateAccount} size="lg" color="white"/>
                    </div>
                ...
                <div id='modalContainer'>
                    ...
                    { firstSection && <form className='inputSection' onSubmit={showSecondSection}>
                        <input placeholder='Firstname' type='text' value={firstname} onChange={(e) => setFirstname(e.target.value)} required/>
                        <input placeholder='Lastname' type='text' value={lastname} onChange={(e) => setLastname(e.target.value)} required/>
                        <input placeholder='Email' type='email' value={email} onChange={(e) => setEmail(e.target.value)} required/>
                        <input placeholder='Phone No' type='text' value={phoneNo} onChange={(e) => setPhoneNo(e.target.value)} required/>
                    ...
                    {/*Second Section */}
                    { secondSection && <form className='inputSection' onSubmit={handleRegistration}>
