    ...
    <div id="signInBackdrop">
      <div id="signInModal">
        <div id="imageContainer">
          <div id="font"><FontAwesomeIcon icon={faXmark} onClick={handleCancelSignin} size="lg" color="white"/></div>
          <div id="img"><img alt="Not Displaying" src={Looner_Logo}/></div>
        </div>
        ...
        <div className="externalSignin" id="forgotPassword" onClick={toggleForgetpassword}>
          {/* Todo: Facebook Logo */}
