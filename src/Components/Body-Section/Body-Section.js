    ...
    <div className="each-body-post">
      ...
      <div className="main-post-section">
        <div className="user-identity-section">
          <div>
            <span className="post-name">{page.user.firstname} {page.user.lastname}</span>
          </div>
          <div>
        ...
        { page.image && <img alt="No Pic" src={page.image} className="post-image-section" />}
        <div className="reaction-section">
          <div className="comment">
            <FontAwesomeIcon icon={faComment} className="reactions-numbers-comment" />
            <span className="reactions-numbers-comment">0</span>
          </div>
          <div className="like">
            <FontAwesomeIcon icon={faHeart} className="reactions-numbers-like" />
